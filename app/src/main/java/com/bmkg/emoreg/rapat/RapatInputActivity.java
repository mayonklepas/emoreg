...
public class RapatInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rapat_input);
    ...
    private void simpan(final String id_master) {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, Config.url + "insert-rapat.php", new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(RapatInputActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onRequestFinished(Request<Object> request) {
               pd.dismiss();
                if(status==0){
                    ...
                    AlertDialog.Builder adb=new AlertDialog.Builder(RapatInputActivity.this);
                    adb.setTitle("Informasi");
                    adb.setMessage("Rapat Berhasil Dikirim");
    ...
    private class exectast extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String pesan="Pengirim : "+Config.email+" ("+Config.nama+") "+"\n"+
                    ...
                    "Isi Rapat : "+edjudul.getText().toString();
