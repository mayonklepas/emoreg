...
public class RapatAdapter extends RecyclerView.Adapter {
    ...
    public RapatAdapter(ArrayList<RapatModel> model, Context ct, String judul_pengajuan) {
        this.model = model;
        this.ct = ct;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType==header){
            ...
            v=lin.inflate(R.layout.adapter_rapat_in,parent,false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof Header){
            ...
            h.thead.setText("Daftar Data Rapat " + judul_pengajuan);
