...
public class MasukanInputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_masukan_input);
    ...
    private void simpan(final String id_master) {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, Config.url + "insert-masukan.php", new Response.Listener<String>() {
            @Override
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(MasukanInputActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onRequestFinished(Request<Object> request) {
               pd.dismiss();
                if(status==0){
                    ...
                    AlertDialog.Builder adb=new AlertDialog.Builder(MasukanInputActivity.this);
                    adb.setTitle("Informasi");
                    adb.setMessage("Masukan Berhasil Dikirim");
    ...
    private class exectast extends AsyncTask<Void,Void,Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            String pesan="Pengirim : "+Config.email+" ("+Config.nama+") "+"\n"+
                    ...
                    "Isi Masukan : "+edjudul.getText().toString();
