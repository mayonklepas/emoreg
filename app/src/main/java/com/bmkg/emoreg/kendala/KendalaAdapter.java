...
import com.bmkg.emoreg.kendala.KendalaModel;
...
public class KendalaAdapter extends RecyclerView.Adapter {
    ArrayList<KendalaModel> model=new ArrayList<>();
    Context ct;
    public static int header=0;
    public static int content=1;
    public String judul_pengajuan;

    public KendalaAdapter(ArrayList<KendalaModel> model, Context ct,String judul_pengajuan) {
        this.model = model;
        this.ct = ct;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType==header){
            ...
            v=lin.inflate(R.layout.adapter_kendala_in,parent,false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof Header){
            ...
            h.thead.setText("Daftar Data Kendala "+judul_pengajuan);
