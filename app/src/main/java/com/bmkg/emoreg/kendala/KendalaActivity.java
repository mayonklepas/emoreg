...
public class KendalaActivity extends AppCompatActivity {
    ...
    ArrayList<KendalaModel> model = new ArrayList<>();
    KendalaAdapter adapter;
    ProgressBar pb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new KendalaAdapter(model,this,judul_pengajuan);
        ...
        fbadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent in=new Intent(KendalaActivity.this,KendalaInputActivity.class);
    ...
    private void loaddata(final String id) {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, Config.url + "daftar-kendala.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i = 0; i < jastatus.length(); i++) {
                        ...
                        model.add(new KendalaModel(String.valueOf(no),tanggal,nama_pegawai,unit_kerja,judul,keterangan,attachment));
                    }
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(KendalaActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
