...
public class KendalaModel {

    String no,tanggal,nama_pegawai,unit_kerja,judul,keterangan,attachment;

    public KendalaModel(String no, String tanggal, String nama_pegawai, String unit_kerja, String judul, String keterangan, String attachment) {
        this.no = no;
